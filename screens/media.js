                ...
                <Pressable onPress={()=>{
                  navigation.navigate('profile',{"user":item,'myid':myid})
                    ...
                    <ImageBackground source={
                     ...
                     // [Math.floor(Math.random(0)*item.media.length)]
                      
                      {uri:item.media[Math.floor(Math.random(0)*item.media.length)]}} style={{height:width*.32,justifyContent:"flex-end",width:width*.32,padding:5}}> 
